...
class Level1(State):
    def __init__(self, game):
        ...
        # Define data as an instance variable
        self.data = {
            'coins': 0
        }
        ...
        self.coin_positions = [(2, 2), (7, 2), (9, 2), (11, 2), (4, 3),
        ...
        self.initial_grid_x = 1
        self.initial_grid_y = 2
        self.player_initial_position = (self.initial_grid_x * self.grid_cell_size, self.initial_grid_y * self.grid_cell_size)
        self.player = Player(self.alien_images, self.grid_cell_size, self.walls, animation_speed=0.9, initial_position=self.player_initial_position)
    ...
    def update(self, deltatime, actions):
        ...
        if self.player.rect.colliderect(self.end_rect):
            ...
            self.save_collected_coins()  # Save coins to JSON
        ...
        for coin in self.coins:
            if self.player.rect.colliderect(coin.rect):
                ...
                self.data['coins'] += 1
                self.save_collected_coins()  # Save coins to JSON dynamically
    ...
    def render(self, display, font):
        ...
        if self.time_up and not self.player_won:
            ...
            self.coin_earn = self.collected_coins
            

            self.exit += 1
            if self.player_won and self.exit == 1:
                print(f"{self.collected_coins}")
                self.exit_state()
