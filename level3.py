...
class Level3(State):
    def __init__(self, game):
        ...
        try:
            ...
            self.alien_images = [
                pygame.transform.scale(pygame.image.load('images/alien3_0.png'), (45, 45)),
                pygame.transform.scale(pygame.image.load('images/alien3_1.png'), (45, 45)),
                pygame.transform.scale(pygame.image.load('images/alien3_2.png'), (45, 45)),
                pygame.transform.scale(pygame.image.load('images/alien3_3.png'), (45, 45))
            ]
        ...
        self.num_cols = len(self.level3[0])
        self.num_rows = len(self.level3)
        self.grid_cell_size = 25
    ...
    def parse_level(self):
        for y, row in enumerate(self.level3):
