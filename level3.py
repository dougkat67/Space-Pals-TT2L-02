...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, image, grid_size, walls, player, initial_position):
        super().__init__()
        self.image = image
        ...
        self.walls = walls
        self.player = player
        self.direction = 1  # initial direction: 1 (moving right)
        self.speed = 2
...
enemy_image = pygame.transform.scale(pygame.image.load('images/enemy.png'),(67, 38))
enemy_positions = [
    (38 * grid_cell_size, 14 * grid_cell_size),
    (5 * grid_cell_size, 3 * grid_cell_size)
    ]
enemies = []
for positions in enemy_positions:
    enemy = Enemy(enemy_image, grid_cell_size, walls, player, positions)
