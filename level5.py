...
enemy4_initial_position = [(25 * grid_cell_size, 9 * grid_cell_size), (29 * grid_cell_size, 9 * grid_cell_size)]
enemy5_initial_position = [(9 * grid_cell_size, 9 * grid_cell_size), (13 * grid_cell_size, 9 * grid_cell_size)]                       
...
enemy4 = Enemy(enemy_image, grid_cell_size, walls, player, enemy4_initial_position)
enemy5 = Enemy(enemy_image, grid_cell_size, walls, player, enemy5_initial_position)
...
all_sprites.add(player, enemy1, enemy2, enemy3, enemy4, enemy5)
